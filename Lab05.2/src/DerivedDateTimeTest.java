...
class DerivedDateTimeTest {
    ...
    public static void testPresidentsFirst100Days() {
        LocalDate inaug = LocalDate.of(2017, 1, 20);
        LocalDate deadline = inaug.plusDays(100);
    ...
    public static void testPopularBirthdays() {
        ...
        LocalDate conc = nyd.plusWeeks(38);
    ...
    public static void testEarlyRetirement() {
        LocalDate bday = LocalDate.of(1986, 4, 18);
    ...
    public static void testLaborDay() {
        LocalDate sept = LocalDate.of(1986, 9, 18);
        LocalDate laborDay = sept.with(firstInMonth(MONDAY));
    ...
    public static void testElectionDay() {
        ...
        LocalDate elect = nov1.with(firstInMonth(MONDAY)).plusDays(1);
        System.out.println(elect.getDayOfWeek());
    }
    ...
    public static void testAnniversary() {
        ...
        LocalDate aniversary = wedding.plusYears(50);
        LocalDate party = aniversary.with(nextOrSame(SATURDAY));
        System.out.println(aniversary);
