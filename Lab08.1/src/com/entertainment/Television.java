...
public class Television {
    ...
    //television HAS_A tuner
    private Tuner tuner = new Tuner(); //internal, not exposed
    ...
    public void changeChannel(String channel){
        tuner.setChannel(channel); //delegate to tuner for actual work
    }
    ...
    public void setVolume(int volume) {
        if (MIN_VOLUME <= volume && volume <= MAX_VOLUME) {
            ...
            System.out.printf("Invalid volume: %S. Valid Range os %S to %S.\n",
...
//                    "Valid range is [" + MIN_VOLUME + "-" + MAX_VOLUME + "].");
    ...
    public String toString() {
        return String.format("Televisions: Brand = %S, Volume = %S, Display = %S, Channel = %S "
